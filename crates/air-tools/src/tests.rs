...
fn file_read_many_supports_bounded_per_call_max_bytes() {
    ...
    let output = tools
        .call_tool(
            "file.read_many",
            &json!({"files": [{"path": "one.txt", "start_line": 1, "end_line": 1}], "max_bytes_per_file": 5}),
        )
        .unwrap();
    ...
    let capped = tools
        .call_tool(
            "file.read_many",
            &json!({"files": [{"path": "one.txt", "start_line": 1, "end_line": 1}], "max_bytes_per_file": 99}),
        )
        .unwrap();
...
fn file_read_supports_bounded_per_call_max_bytes() {
    ...
    let output = tools
        .call_tool(
            "file.read",
            &json!({"path": "note.txt", "start_line": 1, "end_line": 1, "max_bytes": 8}),
        )
        .unwrap();
    ...
    let capped = tools
        .call_tool(
            "file.read",
            &json!({"path": "note.txt", "start_line": 1, "end_line": 1, "max_bytes": 99}),
        )
        .unwrap();
...
fn file_tools_rebase_external_absolute_paths_by_workspace_suffix() {
    ...
    let read = tools
        .call_tool(
            "read",
            &json!({"filePath": fake_bridge_file, "start_line": 1, "end_line": 1}),
        )
        .unwrap();
...
fn file_read_does_not_truncate_only_because_line_numbers_expand_output() {
    ...
    let output = tools
        .call_tool(
            "file.read",
            &json!({"path": "note.txt", "start_line": 1, "end_line": 20}),
        )
        .unwrap();
...
fn file_read_can_disable_default_line_numbers() {
    ...
    let output = tools
        .call_tool(
            "file.read",
            &json!({"path": "note.txt", "start_line": 1, "end_line": 2, "line_numbers": false}),
        )
        .unwrap();
...
#[test]
fn file_read_truncates_large_selected_ranges_with_range_hint() {
    ...
    let output = tools
        .call_tool(
            "file.read",
            &json!({"path": "large.txt", "start_line": 1, "end_line": 200, "line_numbers": true}),
        )
        .unwrap();

    assert_eq!(output["truncated"], json!(true));
    assert_eq!(output["unscoped_read"], json!(false));
